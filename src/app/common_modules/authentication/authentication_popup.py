...
from src.app.common_modules.authentication.helpers.exceptions import IncorrectPasswordException, NotAdministratorException, \
    NotSystemAdmin, PamException, PasswordExpired, UserDoesntExistException
from src.app.common_modules.authentication.helpers.functions import validateUserCredentials, getLockedOutUsers, getRole
from src.app.common_modules.authentication.lockout_notification import LockoutNotification
...
class AuthenticationPopup:
    def __init__(self, rootManager: RootManager, sessionManager: SessionManager = None,
        ...
        if AuthConfiguration().getConfig() or forceAuthenticate:
            ...
            self.createPasswordEntry.bind("<Button-1>", lambda event: launchKeyboard(event.widget, rootManager.getRoot(),  "Password:  ", hidePassword=True))
