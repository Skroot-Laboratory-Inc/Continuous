from tkinter import Frame, NW, BOTH, TRUE, LEFT, Canvas
...
class VerticalScrolledFrame(Frame):
    ...
    * This frame only allows vertical scrolling
    ...
    def __init__(self, parent, bg,*args, **kw):
        ...
        self.bind_all('<Button-4>', lambda e: canvas.yview_scroll(int(-1 * e.num), 'units'))
        self.bind_all('<Button-5>', lambda e: canvas.yview_scroll(int(e.num), 'units'))
